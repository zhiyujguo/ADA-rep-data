...
se_m_comm <- 1.96*sqrt(var(log(matched.cardnp$num_comments[matched.cardnp$gender == "2"]+1))/nrow(matched.cardnp[matched.cardnp$gender == "2",])+var(log(matched.cardnp$num_comments[matched.cardnp$gender == "1"]+1))/nrow(matched.cardnp[matched.cardnp$gender == "1",]))

m_ups_tau <- mean(log(matched.cardnp$ups[matched.cardnp$gender == "2"]+1))-
  mean(log(matched.cardnp$ups[matched.cardnp$gender == "1"]+1))
se_m_ups <- 1.96*sqrt(var(log(matched.cardnp$ups[matched.cardnp$gender == "2"]+1))/nrow(matched.cardnp[matched.cardnp$gender == "2",])+var(log(matched.cardnp$ups[matched.cardnp$gender == "1"]+1))/nrow(matched.cardnp[matched.cardnp$gender == "1",]))
```
